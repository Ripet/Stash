...
<div class="tab-pane fade col" id="profile" role="tabpanel" aria-labelledby="profile-tab">
    <section class="pnlis m-2 row">
        <form class="p-2" action="model/del.uzsakymas.php" method="post">
            ...
            <button class="btn-outline-danger" type="submit">Ištrinti užsakymą ir detales</button>
    ...
    <section class="pnlis m-2 row">
        ...
        <h3>Pridėti užsakymą</h3>
            ...
            <button class="btn-outline-success" type="submit" onclick="">Pridėti</button>
        </form>
    ...
    <section class="pnlis m-2 row">
        <form class="p-2 col d-flex flex-column" action="model/upd.uzsakymas.php" method="post">
            ...
            <input type="text" name="uzsakID" value="" placeholder="Užsakovo ID">
            <button class="btn-outline-info" type="submit" onclick="">Koreguoti</button>
        </form>
